        ...
        <Flex position="relative" right="-40px">
            ...
            <Box w='450px' h='100px' position="relative" right="-160px" bottom="-50px" >
                ...
                <Flex>
                    ...
                    <Text position="relative" bottom="-220px" right="-340px">{Intl.NumberFormat("en-US").format(totalPrice)} บาท</Text>
                </Flex>
                <Flex>
                    <Text position="relative" bottom="-230px">จัดส่งโดยรถบรรทุก</Text>
                    <Text position="relative" bottom="-230px" right="-260px">0บาท</Text>
                </Flex>
                <Flex>
