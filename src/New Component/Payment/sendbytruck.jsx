...
const sendbytruck = () => { // Change function name to start with an uppercase letter
  return (
        ...
        <Flex position="relative" right="-40px">
            ...
            <Box w='450px' h='100px' position="relative" right="-160px" bottom="-50px" >
                ...
                <Flex>
                    ...
                    <Text position="relative" bottom="-220px" right="-340px">1,809บาท</Text>
                </Flex>
                <Flex>
                    <Text position="relative" bottom="-230px">จัดส่งโดยรถบรรทุก</Text>
                    <Text position="relative" bottom="-230px" right="-260px">290บาท</Text>
                </Flex>
                <Flex>
                    <Text position="relative" bottom="-240px">วันจัดส่ง</Text>
                    <Text position="relative" bottom="-240px" right="-310px">07 กันยายน</Text>
                </Flex>
                <Text position="relative" bottom="-245px" right="-325px">13:00 น. - 16:00 น.</Text>
                ...
                <Flex>
                    ...
                    <Text position="relative" bottom="-285px" right="-273px" fontWeight="bold" fontSize="32px">2,099</Text>
                ...
                <Link to="/OrderConSBT"><Button w="450px" h="60px" position="relative" bottom="-350px" rounded="100px" bg="#0F63EA" color="white" _hover={{ bgColor: '#0058A3' }}>สั่งซื้อสินค้า</Button></Link>
            ...
            <Box w='390px' h='880px' position="relative" right="-20px" border="1px solid #000">
              <Box borderBottom="1px solid #D3D3D3" w="350px" h="120px" position="relative" right="-18px" >
                <Flex position="relative" bottom="-60px" >
                  ...
                  <Text position="relative" right="-173px" fontSize="30px" top="-15px" fontWeight="bold" letterSpacing="1px">2,099</Text>
              ...
              <Box borderBottom="1px solid #D3D3D3" w="350px" h="150px" position="relative" right="-18px">
                <Text position="relative" bottom="-15px" fontWeight="bold" letterSpacing="1px">วิธีจัดส่งสินค้า</Text>
                <Flex>
                    <Text position="relative" bottom="-25px" color="gray.400">จัดส่งโดยรถบรรทุก</Text>
                    <Text position="relative" bottom="-25px" right="-160px" fontWeight="bold" letterSpacing="1px">290บาท</Text>
                </Flex>
    
                <Flex>
                    <Text position="relative" bottom="-25px" color="gray.400">วันจัดส่ง</Text>
                    <Text position="relative" bottom="-25px" right="-255px" color="gray.400">พรุ่งนี้</Text>
                </Flex>
                
                <Text position="relative" bottom="-25px" right="-230px" color="gray.400">13:00 น. - 16:00 น.</Text>
              </Box>
