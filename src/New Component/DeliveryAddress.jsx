...
const AddAddress = () => {
    ...
    return (
        <Box>
          <Button onClick={onOpen} w="113px" h="40px" position="relative" top="10px" borderRadius="8px" bg="#0F63E9" border="none" p={0} _hover={{ bg: '#0F63E9', boxShadow: '0 5px 10px rgba(0, 0, 0, .1)'  }}>
            <Image src={add} alt="add" width="20px" height="20px" position="relative" left="-5px"/>
            <Text color="white" fontSize="14" position="relative" right="-3px">เพิ่มที่อยู่</Text>
          </Button>
            ...
            <Flex h="100%">
                ...
                <Box w="980px" h="100%" position="relative" left="10px" >
                    <Box w="980px" h="68px"> 
                        ...
                        <Text color="#757575" fontSize="12" position="relative" right="-10px" bottom="-5px">จัดการที่อยู่จัดส่ง สำหรับการสั่งซื้อสินค้า</Text>
                    </Box>
                    {/* <Box w="980px" h="100px" bg="blue.200"> 
                    </Box> */}
                    <Box w="980px" h="550px" align="center" justify="center" position="relative" top="150px"> 
                      <Image src={homelocation} alt="homelocation" borderRadius="md" width="40px" height="40px" position="relative" top="-20px" />
                      <Text color="#757575" position="relative" top="-5px" >ไม่มีข้อมูลที่อยู่จัดส่งสินค้า</Text>
                      <AddAddress />
                    </Box>
